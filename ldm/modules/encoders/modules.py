...
class SemapEncoder(AbstractEncoder):
    ...
    def _prepare_tensor(self, x):
        ...
        elif len(x.shape) == 3 and x.shape[0] == 4:  # [C, H, W]
...
class MaskEncoder(AbstractEncoder):
    def __init__(self, device="cuda"):
        super().__init__()
        self.device = device
    ...
    def encode(self, mask):
        ...
        if isinstance(mask, list):
            ...
            batch_size = mask.shape[0] if len(mask.shape) > 2 else 1
        else:
            batch_size = 1
